...
from world.rescue_rules import FLUENT_RESCUED, PATIENT_PREFIX
...
class SimpleRescueProblem(Problem):
    ...
    def __init__(self, layout: RescueLayout) -> None:
        ...
        goal = frozenset({(FLUENT_RESCUED, f"{PATIENT_PREFIX}_0")})
...
class MultiRescueProblem(Problem):
    ...
    def __init__(self, layout: RescueLayout) -> None:
        ...
        goal = frozenset({(FLUENT_RESCUED, patient) for patient in objects["patients"]})
